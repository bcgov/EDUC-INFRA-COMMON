...
```
helm upgrade --install -n <namespace>-<env> clamav ./charts/clamav -f ./charts/clamav/<env>/values.yaml
```

example

```
helm upgrade --install -n 75e61b-dev clamav ./charts/clamav -f ./charts/clamav/dev/values.yaml
```
